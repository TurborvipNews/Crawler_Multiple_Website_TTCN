package com.turborvip.crawler.application.scheduler;
...
import com.turborvip.crawler.application.utils.CrawlUtil.CrawlByDanTri;
import com.turborvip.crawler.application.utils.CrawlUtil.CrawlByZingNews;
import com.turborvip.crawler.application.utils.CrawlUtil.CrawlStrategy;
import com.turborvip.crawler.application.utils.CrawlUtil.Crawler;
...
public class CrawlerNewsTask {
    ...
    public void crawlerNews() throws IOException, InterruptedException {
        try {
            ...
            List<CategoryInfo> categories = categoryService.getAll();
